  ...
  describe('tuli', () => {
    describe('20210101', () => {
      it('requires all keys', () => {
        const validator = new Validator('tuli-20210101')
        const json = {
          description: 'blah',
    ...
    describe('20210604', () => {
      it('requires all keys', () => {
        const validator = new Validator('tuli-20210604')
        const json = {
          description: 'blah',
          mimeType: 'application/json',
          name: 'who cares'
      ...
      it('validates a valid full schema', () => {
        ...
        const json = {
          ...
          version: 'tuli-20210604',
          image: 'someURL',
          external_url: 'tuli.ink',
          animation_url: 'tuli.ink',
